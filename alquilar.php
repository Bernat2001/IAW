...
<form method="post">
<?php echo $_GET['primaria']; ?>
    <br><br><label>Incidencia: </label>
        <textarea name="incidencia"></textarea>
    <br>
    <input type="submit" name="baja" value="Dar de baja">
    <input type="submit" name="Volver" value="Volver" formaction="index.php" class="boton">
</form>
<?php
