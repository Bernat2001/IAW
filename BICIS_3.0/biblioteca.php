  ...
  function mostrar_tabla($result) {
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        if ($row['incidencias'] == "sin incidencias") {
          ...
          echo "<td>INCIDENCIA   <span class='cuadrado-rojo'></span>
          <br>" .$row['incidencias'] .'</td>';
        }        
        if ($row['disponible'] == 1) {
        ...
        echo "<td></td>";
          ...
          if ($row['disponible'] == 1) {
            ...
            echo "<td>"."<a href='devolver.php?primaria=".$row['codigo_bi']."'id='devolver'>Devolver</a></td>";
          }
        }
        if ($row['incidencias'] == 'sin incidencias') {
          echo "<td>"."<a href='baja.php?primaria=".$row['codigo_bi']."'id='enlaces'>Dar de baja</a></td>";
        } else {
          echo "<td>"."<a href='alta.php?primaria=".$row['codigo_bi']."'id='enlaces'>Dar de alta</a></td>";
        }
